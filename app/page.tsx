          ...
          <section className="mb-16 md:mb-32">
            <div className="grid md:grid-cols-2 gap-4 md:gap-6">
              <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-5 md:p-6 hover:bg-white/10 transition-all md:hover:scale-105">
                <h3 className="text-lg md:text-xl font-mono text-primary mb-2 md:mb-3">{t.landing.analysis}</h3>
                <p className="text-gray-300 text-sm md:text-base leading-relaxed">
                  {t.landing.analysisDesc}
                </p>
              </div>

              <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-5 md:p-6 hover:bg-white/10 transition-all md:hover:scale-105">
                <h3 className="text-lg md:text-xl font-mono text-primary mb-2 md:mb-3">{t.landing.execution}</h3>
                <p className="text-gray-300 text-sm md:text-base leading-relaxed">
                  {t.landing.executionDesc}
                </p>
              </div>

              <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-5 md:p-6 hover:bg-white/10 transition-all md:hover:scale-105">
                <h3 className="text-lg md:text-xl font-mono text-primary mb-2 md:mb-3">{t.landing.scanner}</h3>
                <p className="text-gray-300 text-sm md:text-base leading-relaxed">
                  {t.landing.scannerDesc}
                </p>
              </div>

              <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-5 md:p-6 hover:bg-white/10 transition-all md:hover:scale-105">
                <h3 className="text-lg md:text-xl font-mono text-primary mb-2 md:mb-3">{t.landing.tracking}</h3>
                <p className="text-gray-300 text-sm md:text-base leading-relaxed">
          ...
          <section className="mb-16 md:mb-32">
            ...
            <div className="grid md:grid-cols-2 gap-4 md:gap-6">
              <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-5 md:p-6 hover:bg-white/10 transition-all">
                <span className="text-primary font-mono text-base md:text-lg">{t.landing.timeframes}</span>
                <p className="text-gray-300 text-sm md:text-base mt-2">{t.landing.timeframesDesc}</p>
              </div>
              <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-5 md:p-6 hover:bg-white/10 transition-all">
                <span className="text-primary font-mono text-base md:text-lg">{t.landing.indicators}</span>
                <p className="text-gray-300 text-sm md:text-base mt-2">{t.landing.indicatorsDesc}</p>
              </div>
              <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-5 md:p-6 hover:bg-white/10 transition-all">
                <span className="text-primary font-mono text-base md:text-lg">{t.landing.patterns}</span>
                <p className="text-gray-300 text-sm md:text-base mt-2">{t.landing.patternsDesc}</p>
              </div>
              <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-5 md:p-6 hover:bg-white/10 transition-all">
                <span className="text-primary font-mono text-base md:text-lg">{t.landing.orders}</span>
                <p className="text-gray-300 text-sm md:text-base mt-2">{t.landing.ordersDesc}</p>
              </div>
            </div>
          </section>
              ...
              <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-5 md:p-8 hover:bg-white/10 transition-all group">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-primary font-mono text-base md:text-lg mb-2">{t.landing.connect}</p>
                    <p className="text-gray-300 text-sm md:text-base">{t.landing.connectDesc}</p>
                  </div>
                </div>
              </div>
              <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-5 md:p-8 hover:bg-white/10 transition-all group">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-primary font-mono text-base md:text-lg mb-2">{t.landing.scan}</p>
                    <p className="text-gray-300 text-sm md:text-base">{t.landing.scanDesc}</p>
                  </div>
                </div>
              </div>
              <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-5 md:p-8 hover:bg-white/10 transition-all group">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-primary font-mono text-base md:text-lg mb-2">{t.landing.sendIt}</p>
                    <p className="text-gray-300 text-sm md:text-base">{t.landing.sendItDesc}</p>
                  </div>
                </div>
              </div>
              <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-5 md:p-8 hover:bg-white/10 transition-all group">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-primary font-mono text-base md:text-lg mb-2">{t.landing.review}</p>
                    <p className="text-gray-300 text-sm md:text-base">{t.landing.reviewDesc}</p>
                  </div>
                </div>
              </div>
            </div>
